...
ActiveRecord::Schema.define(version: 2019_03_18_213236) do
  ...
  create_table "post_attachments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["attachment_id"], name: "index_post_attachments_on_attachment_id"
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.index ["postattachment_id"], name: "index_posts_on_postattachment_id"
    t.index ["posttag_id"], name: "index_posts_on_posttag_id"
